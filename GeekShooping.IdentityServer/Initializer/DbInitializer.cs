    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "angelo-admin@email.com.br",
                EmailConfirmed = true,
            ...
            _user.CreateAsync(admin, "Secreto123$").GetAwaiter().GetResult();
            ...
            ApplicationUser client = new ApplicationUser()
            {
                ...
                Email = "angelo-client@email.com.br",
                EmailConfirmed = true,
                PhoneNumber = "+55 (34) 12345-6789",
                FirstName = "Angelo",
                LastName = "Client"
            ...
            _user.CreateAsync(client, "Secreto123$").GetAwaiter().GetResult();
